...
powershell -ExecutionPolicy Bypass -File C:\tmp\roma-windows-agent\check-windows-proof-report.ps1 -ProofReportPath C:\tmp\roma-windows-agent-doctor-proof.json -ExpectedMode doctor-only -RequireWindowsPlatform -RequirePermissionSurface -RequireProofAgentSurface
