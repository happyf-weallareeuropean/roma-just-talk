...
powershell -ExecutionPolicy Bypass -File C:\tmp\roma-windows-agent\check-windows-proof-report.ps1 -ProofReportPath C:\tmp\roma-windows-agent-notepad-paste-proof.json -ExpectedMode local-whisper -RequireWindowsPlatform -RequireInstall -RequirePermissionSurface -RequireHoldHook -RequireWhisperConfig -RequireNotepadPaste
