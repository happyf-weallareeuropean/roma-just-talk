...
powershell -ExecutionPolicy Bypass -File C:\tmp\roma-windows-agent\check-windows-proof-report.ps1 -ProofReportPath C:\tmp\roma-windows-agent-doctor-proof.json -ExpectedMode doctor-only -RequireWindowsPlatform -RequirePermissionSurface -RequireProofAgentSurface -RequireNativeDoctorSurface
...
powershell -ExecutionPolicy Bypass -File C:\tmp\roma-windows-agent\check-windows-proof-report.ps1 -ProofReportPath C:\tmp\roma-windows-agent-proof.json -ExpectedMode cloud -RequireWindowsPlatform -RequireInstall -RequireShortcut -RequireStartupShortcut -RequirePermissionSurface -RequireProofAgentSurface -RequireNativeDoctorSurface -RequireHoldHook -RequireCloudConfig -RequireDictation -RequirePaste
...
powershell -ExecutionPolicy Bypass -File C:\tmp\roma-windows-agent\check-windows-proof-report.ps1 -ProofReportPath C:\tmp\roma-windows-agent-notepad-paste-proof.json -ExpectedMode local-whisper -RequireWindowsPlatform -RequireInstall -RequirePermissionSurface -RequireProofAgentSurface -RequireNativeDoctorSurface -RequireHoldHook -RequireWhisperConfig -RequireNotepadPaste
...
powershell -ExecutionPolicy Bypass -File C:\tmp\roma-windows-agent\check-windows-proof-report.ps1 -ProofReportPath C:\tmp\roma-windows-agent-local-whisper-proof.json -ExpectedMode local-whisper -RequireWindowsPlatform -RequireInstall -RequireShortcut -RequireStartupShortcut -RequirePermissionSurface -RequireProofAgentSurface -RequireNativeDoctorSurface -RequireHoldHook -RequireWhisperConfig -RequireDictation -RequirePaste
```
